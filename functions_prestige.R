...
biased_transmission_demonstrator_continuous <- function(N, p_0, c_s, c_copy, alpha_attr, t_max, r_max, beta, sd_error) {
  ...
  for (r in 1:r_max) {
    ...
    for (t in 2:t_max) {
      ...
      prestige_population$trait <- (1 - beta) * prestige_population$trait + beta*population$trait[demonstrator_index] + 
        (1 - prestige_population$trait)*alpha_attr + errors
